...
export const translations = {
  vi: {
    ...
    loading: 'Đang tải...',
    errorFailedToLoadApps: 'Không thể tải danh sách ứng dụng.',
    appCode: 'Mã Ứng dụng',
    delete: 'Xóa',
    confirmDeleteApp: 'Bạn có chắc chắn muốn xóa ứng dụng này không? Thao tác này không thể hoàn tác.',
    errorPrefix: 'Lỗi: ',
    operationFailed: 'Thao tác thất bại.',
    deleteFailed: 'Xóa thất bại.',
    editApplication: 'Chỉnh sửa Ứng dụng',
    addNewApplication: 'Thêm Ứng dụng Mới',
    failedToFetchServers: 'Lấy danh sách máy chủ thất bại.',
    failedToSaveServer: 'Lưu máy chủ thất bại.',
    failedToDeleteServer: 'Xóa máy chủ thất bại.',
    testingConnection: 'Đang kiểm tra kết nối cho server ID: {id}. Vui lòng chờ cập nhật trạng thái.',
    hostname: 'Hostname',
    ipAddress: 'Địa chỉ IP',
    technology: 'Công nghệ',
    actions: 'Hành động',
    test: 'Kiểm tra',
    technologyCommaSeparated: 'Công nghệ (phân cách bởi dấu phẩy)',
    sshUser: 'User SSH',
    confirmDeleteServer: 'Bạn có chắc chắn muốn xóa máy chủ này không?',
    addServer: 'Thêm Server',
    editServer: 'Sửa Server',
    searchServer: 'Tìm kiếm server...',
    testingConnectionTitle: 'Log Test Kết nối',
    waitingForLogs: 'Đang chờ log...',
    noLogsFromServer: 'Không nhận được log từ server.',
    errorTestingConnection: 'Lỗi trong quá trình test kết nối:',
    selectApplication: 'Chọn một Ứng dụng'
  },
  en: {
    ...
    loading: 'Loading...',
    errorFailedToLoadApps: 'Failed to load application list.',
    ...
    failedToFetchServers: 'Failed to fetch servers.',
    failedToSaveServer: 'Failed to save server.',
    failedToDeleteServer: 'Failed to delete server.',
    testingConnection: 'Testing connection for server ID: {id}. Please wait for status update.',
    hostname: 'Hostname',
    ipAddress: 'IP Address',
    technology: 'Technology',
    actions: 'Actions',
    test: 'Test',
    technologyCommaSeparated: 'Technology (comma separated)',
    sshUser: 'SSH User',
    confirmDeleteServer: 'Are you sure you want to delete this server?',
    addServer: 'Add Server',
    editServer: 'Edit Server',
    searchServer: 'Search server...',
    testingConnectionTitle: 'Connection Test Log',
    waitingForLogs: 'Waiting for logs...',
    noLogsFromServer: 'No logs received from server.',
    errorTestingConnection: 'Error during connection test:',
